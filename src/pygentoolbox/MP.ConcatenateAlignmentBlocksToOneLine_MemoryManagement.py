...
def concatenate_files(filelist, specieslist):
    ...
    with open(outfile, 'a') as OUT:
        ...
        for species in specieslist:
            ...
            print('Finished concatenating species: %s' % species)
            print(datetime.datetime.now())
    for f in filelist:
        os.remove(f)
...
main('chr22_version1.aln', 'Species251.txt', 'Homo_sapiens')  # test with align file chr22_version1.aln.n1000000.txt
